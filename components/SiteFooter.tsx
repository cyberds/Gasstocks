...
export default function SiteFooter() {
  ...
  return (
    <>
      <footer style={{ padding: '28px 32px', borderTop: '1px solid var(--color-divider)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '24px', flexWrap: 'wrap', fontSize: '11.5px', color: 'color-mix(in srgb,var(--color-text) 52%,transparent)' }}>
